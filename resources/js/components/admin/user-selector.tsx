...
export function UserSelector({ users, selectedUserIds, onSelectionChange, placeholder = 'Select users...', className }: UserSelectorProps) {
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    role="combobox"
                    aria-expanded={open}
                    className={cn('h-auto min-h-10 w-full justify-between py-2', className)}
                >
                    ...
                    <CommandList>
                        ...
                        <CommandGroup>
                            {filteredUsers.map((user) => {
                                ...
                                return (
                                    <CommandItem key={user.id} value={`${user.name} ${user.email}`} onSelect={() => handleSelect(String(user.id))}>
