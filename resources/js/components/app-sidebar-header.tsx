                    ...
                    <div className="flex items-center gap-2">
                        {isMobile ? (
                            ...
                            >
                                ...
                                <kbd className="pointer-events-none hidden h-5 items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100 select-none sm:inline-flex">
