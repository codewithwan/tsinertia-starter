...
export default function CliSuccess({ message, redirect_url, autoClose = true }: CliSuccessProps) {
    ...
    return (
        <AuthLayout title="Authorization Successful" description="You can close this window and return to your terminal">
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">{message || 'You can close this window and return to your terminal.'}</p>
                </div>
