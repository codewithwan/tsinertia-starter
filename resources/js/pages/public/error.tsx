...
import { Home, RefreshCw, ArrowLeft, Search, Shield, AlertTriangle, Server, Lock, Clock, XCircle } from 'lucide-react';
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-foreground/5 border border-foreground/10 mb-8"
                    >
                    ...
                    >
                        <Button 
                            size="lg" 
                            className="group relative overflow-hidden px-8 py-6 text-base shadow-lg shadow-primary/25" 
                            asChild
                        >
                            <Link href="/">
